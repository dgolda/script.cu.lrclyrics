        ...
        while (not xbmc.abortRequested) and (WIN.getProperty('culrc.quit') == ''):
            ...
            if xbmc.getCondVisibility("Window.IsVisible(12006)"):
                if not self.triggered:
                    ...
                    xbmc.executebuiltin((u'Notification(%s,%s,%i)' % (__addonname__ , __language__(30004), 2000)).encode('utf-8', 'ignore'))
        ...
        for cnt in range( 5 ):
            ...
            if ( song and ( self.current_lyrics.song != song ) ):
                ...
                if lyrics.lyrics:
                    ...
                    xbmc.executebuiltin((u'Notification(%s,%s,%i)' % (__addonname__ + ": " + __language__(30001), song.artist + " - " + song.title, 2000)).encode('utf-8', 'ignore'))
                break
            xbmc.sleep( 50 )
